...
public final class EditarDispositivoBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static EditarDispositivoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EditarDispositivoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.editar_dispositivo, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EditarDispositivoBinding bind(@NonNull View rootView) {
