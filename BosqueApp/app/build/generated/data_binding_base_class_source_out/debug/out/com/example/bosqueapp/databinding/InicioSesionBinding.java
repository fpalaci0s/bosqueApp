...
public final class InicioSesionBinding implements ViewBinding {
  ...
  private InicioSesionBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton loginButton,
  ...
  public static InicioSesionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new InicioSesionBinding((LinearLayout) rootView, loginButton, passwordInput,
          registerText, usernameInput);
    }
